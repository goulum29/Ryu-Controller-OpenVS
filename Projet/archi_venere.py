...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        host4 = self.addHost( 'h4', ip='192.168.30.1/24',defaultRoute='via 192.168.40.254')
        host5 = self.addHost( 'h5', ip='192.168.30.1/24',defaultRoute='via 192.168.30.254')
        host6 = self.addHost( 'h6', ip='192.168.30.1/24',defaultRoute='via 192.168.30.254')
